...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content, Priority priority) {
        ...
        values.put(TodoProContract.TodoNote.COLUMN_CONTENT, content);
        values.put(TodoProContract.TodoNote.COLUMN_STATE, 0);//初始化的状态为 to do 对应的状态值为0，如果完成那么 done 状态值为1
        values.put(TodoProContract.TodoNote.COLUMN_DATE, System.currentTimeMillis());
        values.put(TodoProContract.TodoNote.COLUMN_PRIORITY, priority.intValue);
        long rowId = database.insert(TodoProContract.TodoNote.TABLE_NAME, null, values);
        return rowId != -1;
    }
